...
public class Get_IngredientsList {
	...
	public static ArrayList<String> get_LFV_FV_EliminateList(String fileName, int columnNumber) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		ArrayList<String> eliminateList = get_LFV_FV_EliminateList(fileName, 0); // read column 1
