	...
	public static void main(String[] args) {
		...
		try {
			...
			for (i = 0; i < links.size() - 1; i++) {
				...
				// Compare above cuisine category master list list with tags and assign value to
				// cuisineCategory
...
//						}
				...
				recipes.add(new recipeObj(ids.get(i), name, recipeCategory, foodCategory, ingredients, prepTime,
						cookTime, tags, numServings, cuisineCategory, description, prepMethod, nutrients, link));
			}
